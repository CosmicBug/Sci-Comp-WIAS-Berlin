...
scalarplot!(vis2d, gridplot, sol33[1, :, 2], size=(300, 300), title="solution 2D", show=true)

# ╔═╡ f6d62e40-c3a3-11ec-2720-c7ffea32772e
begin
    visr=GridVisualizer(Plotter=Plots,resolution=(800,400))

    t=@elapsed begin
        sol2,sys,err=run_diffeq(m=2,n=20,solver=nothing, unknown_storage=:dense)
    end
...
# ╔═╡ 8a468faf-81eb-4035-962e-0add31d0a92a
#=╠═╡
begin 
	save1=[]
	for i in 10:5:70
