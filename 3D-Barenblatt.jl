...
# ╔═╡ c22e3c34-f4b7-4ae2-9e27-015c68fe0d3e
using Plots:surface

# ╔═╡ b28f55e0-c290-11ec-1e21-e760f08e7732
...
# ╔═╡ 95947bdd-bd6b-46e7-9256-adf4926b87f2
...
# ╔═╡ e7f25fe3-eef1-4a35-9f83-4b6400ec5078
begin 
	x=collect(-1:0.1:1)
	y=collect(-1:0.1:1)
end

# ╔═╡ 6ccc6628-0e2f-4594-babe-ce35bae503ce
function Barenblatt3D(x, y, t, m, d=1, Γ=1) #uses the regular BB func to evuate each element of matrix r(x,y) and gives a BB func weighted matrix out 
	...
	funcMatrix = map(x->barenblatt(x,0.01,2), mat)
	return funcMatrix
end

# ╔═╡ 1b58a69e-bbc8-4297-8356-ba45f8ac3bf2
shank = Barenblatt3D(x, y, 0.01, 2, 1, 1) #map(x->barenblatt(x,0.01,2), mat)

# ╔═╡ ad4a03b2-1ac9-4715-b69e-d6969ccbc316
surface(shank)
